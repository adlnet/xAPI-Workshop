xapicharts = function(){
 ...
 console.log("dual");
    ...
    var queryModuleLaunchesAndReadsPerPage = function(){
        ...
        var introStmts = getCompleteStatementListFromLRS(search);
        ...
        var introReadStmts = getCompleteStatementListFromLRS(search);
        ...
        search['verb'] = ADL.verbs.launched.id;  
        var ingredientStmts = getCompleteStatementListFromLRS(search);
        ...
        var ingredientReadStmts = getCompleteStatementListFromLRS(search);
        ...
        ingredientReadStmts = getCompleteStatementListFromLRS(search);
        ...
        search['verb'] = ADL.verbs.launched.id;  
        var stepsStmts = getCompleteStatementListFromLRS(search);
    ...
    var queryLaunchesPerModule = function(){
        ...
        var videoStmts = getCompleteStatementListFromLRS(search);
        _numberList[3] = videoStmts.length;
        
        // for quiz
        search['activity'] = "http://adlnet.gov/xapi/samples/xapi-jqm/course/05-quiz";
        var quizStmts = getCompleteStatementListFromLRS(search);
